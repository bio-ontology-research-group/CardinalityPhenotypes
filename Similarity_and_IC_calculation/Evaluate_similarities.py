...
def computeROC_AUC(OGs_HDs_sim,HDs_keys,OGs_keys,h_positives):
    ...
    with open('ranking_dic_'+sys.argv[2].replace("/","")+'.json', 'w') as fb:
        json.dump(ranking_dic_disease,fb)
    with open('ranking_dic_'+sys.argv[1].replace("/","")+'.json', 'w') as fb:
...
OGs_HDs_sim = np.load(disease_genes_similarity_matrix)
...
print("Precision@1 @5 @10 @50 = ",precisionAt(TPR,P,FPR,N,1),precisionAt(TPR,P,FPR,N,5),precisionAt(TPR,P,FPR,N,10),precisionAt(TPR,P,FPR,N,50))
print("Recall@1 @5 @10 @50 = ",recallAt(TPR,P,FPR,N,1),recallAt(TPR,P,FPR,N,5),recallAt(TPR,P,FPR,N,10),recallAt(TPR,P,FPR,N,50))
print("Hits@1 @5 @10 @50 = ",hitAt(TPR,P,FPR,N,1),hitAt(TPR,P,FPR,N,5),hitAt(TPR,P,FPR,N,10),hitAt(TPR,P,FPR,N,50))
